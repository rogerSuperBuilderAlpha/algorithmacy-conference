...
function validate(b) {
  ...
  const specialSession = str(b.specialSession);

  return {
    errors,
    clean: { title, authors, email, type, track, keywords, wordCount: words, abstract, outline, bios, contribution, coi, specialSession },
  };
}
