...
- MIL programs frame disinformation as individual deficiency correctable through education, but this paper argues they instead responsibilise citizens to manage informational risk while leaving the infrastructures that produce trust or distrust unaddressed and opaque.
- Reframes risk and literacy as governmental technologies — historically tools of population management rather than liberation — and extends this to the digital sphere, where literacy cannot be separated from the infrastructures through which information circulates.
- Examines the Educational and Digital Awareness Mission (E-DAM) in Kerala's Thaliparamba constituency, built on the state's FOSS education policy and mass organisational infrastructure (libraries, vayanashalas, Kudumbashree, party-linked organisations).
- Fieldwork shows vayanashalas (reading rooms) as sites where trust in information is negotiated face-to-face rather than individually, continuous with their earlier role in Kerala's Total Literacy Mission — alongside tensions around political mobilisation and an absent critical-evaluation curriculum.
- Concludes that trust in information is governed by a pre-existing material-institutional-political infrastructure that conditions digital literacy, such that compliance or refusal turns less on individual competency than on who controls that infrastructure.

## Author bios

Ananthu is a PhD student at the Humanities and Social Sciences department of the Indian Institute of Technology Delhi, where he works on Technology and Society, particularly on the epistemology of the internet, disinformation, literacies and information infrastructures. He has previously worked with freelance media and on a project titled "Advancing Data Justice Research and Practice in India."
