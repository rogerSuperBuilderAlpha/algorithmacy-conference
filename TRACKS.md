...
The foundational track. Definitions of algorithmacy, the triadic form, the lineage from oracy and literacy.
...
Performance metrics, surveillance, scheduling, ranking, matching. The interface between worker and system.
...
Gig work, content moderation, platform-specific tactics, organizing, collective action.
...
Information asymmetries, audit, codetermination, regulation, accountability.
...
Research methodology, historical context, field accounts, design interventions.
...
The following themes are welcome across any track. Surface them in your keywords.

- **Identity & subjectivity** — how algorithmic systems shape who workers become
- **Skill & algorithmic literacy** — what workers know, how they learn it
- **Trust & legitimacy** — why workers comply, and when they stop
